...
1. Учетная запись Яндекс с активной подпиской Плюс
2. Мобильное приложение Яндекс Браузер с настроенным аккаунтом
3. Камера с функцией сканирования QR-кода (альтернатива)

- Ручной шаг: сканирование QR-кода занимает до 1 минуты
