...
- После многократных запусков тестов может пропасть выбор дополнительной защиты аккаунта (ее нельзя будет пропустить, пропадает через время или при использовании другого аккаунта Яндекс)
